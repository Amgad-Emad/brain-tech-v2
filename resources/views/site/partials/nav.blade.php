...
<header style="position:fixed;top:0;left:0;right:0;z-index:100;">
    <nav class="bt-nav" data-nav aria-label="Primary">
        <div style="max-width:1240px;margin:0 auto;padding:0 28px;height:72px;display:grid;grid-template-columns:1fr auto 1fr;align-items:center;">
            <a href="{{ route('home') }}" style="display:flex;align-items:center;gap:11px;text-decoration:none;color:var(--fg);justify-self:start;">
                <span style="width:38px;height:38px;border-radius:10px;background:#0c0c11;border:1px solid rgba(255,255,255,0.1);display:inline-flex;align-items:center;justify-content:center;box-shadow:0 4px 16px rgba(var(--accRGB),0.3);">
                ...
                <span style="font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:18px;letter-spacing:-0.01em;">Brain<span style="color:var(--acc);">Tech</span></span>
            </a>
            ...
            <div style="justify-self:end;display:flex;align-items:center;gap:8px;">
                <a href="{{ locale_url($otherLocale) }}" aria-label="{{ __('site.actions.toggle_lang') }}" style="display:inline-flex;align-items:center;justify-content:center;min-width:42px;height:42px;padding:0 12px;border-radius:11px;background:var(--panel2);border:1px solid var(--border);cursor:pointer;color:var(--fg);font-size:13px;font-weight:600;text-decoration:none;">{{ __('site.lang_label') }}</a>
                <button type="button" data-theme-toggle aria-label="{{ __('site.actions.toggle_theme') }}" style="display:inline-flex;align-items:center;justify-content:center;width:42px;height:42px;border-radius:11px;background:var(--panel2);border:1px solid var(--border);cursor:pointer;color:var(--fg);"><span data-theme-icon>☾</span></button>
                ...
                <button type="button" class="bt-burger" data-menu-toggle aria-label="{{ __('site.actions.toggle_menu') }}" aria-expanded="false" style="display:none;align-items:center;justify-content:center;width:42px;height:42px;border-radius:11px;background:var(--panel2);border:1px solid var(--border);cursor:pointer;color:var(--fg);">
